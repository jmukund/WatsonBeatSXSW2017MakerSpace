...
def CreateArpeggios ( mood, filename, trackname) :
    '''
    a) get Arpeggio file
    b) select an instrument
    c) select a preset
...
def CreateBass ( mood , trackname) :
    ...
    # get bass file
    file = workingDirectory + "bassWB.mid"
...
if __name__ == '__main__' :
    ...
    CreateBass( mood, "BASS")
    CreateMelody( mood, "MELODY")


    CreateArpeggios( mood, "Arp0.mid", "Arp1" )
    CreateArpeggios( mood, "Arp1.mid", "Arp2" )
    CreateArpeggios( mood, "Arp2.mid", "Arp3" )
